...
function createProgressBar() {
    ...
    var path_to_file = "C:/Program Files (x86)/Common Files/Adobe/CEP/extensions/my_first_extension/Export_Layers_To_Files_(Fast)-progress_bar.json";
    var rsrcFile = new File(encodeURI(path_to_file));
...
function showDialog() {
    ...
    var path_to_file = "C:/Program Files (x86)/Common Files/Adobe/CEP/extensions/my_first_extension/Export_Layers_To_Files_(Fast)-dialog.json";
    var rsrcFile = new File(encodeURI(path_to_file));
    var rsrcString = loadResource(rsrcFile);
    if (!rsrcString) {
        return false;
